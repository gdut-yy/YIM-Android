...
public class StickerAdapter extends BaseAdapter {
    ...
    @Override
    public int getCount( ) {
        int count = mCategory.getStickerItems().size() - startIndex;
        count = Math.min(count, EmoticonLayout.STICKER_PER_PAGE);
        return count;
    }
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        StickerItem sticker = mCategory.getStickerItems().get(index);
        if (sticker == null) {
            return view;
        }
